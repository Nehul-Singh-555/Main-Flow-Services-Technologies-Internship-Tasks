...
public class ViewDeleteBuyersForm extends javax.swing.JFrame {
    private MainMenuForm mainMenu;

    
    private DefaultTableModel model;
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(ViewDeleteBuyersForm.class.getName());

    /**
     * Creates new form ViewDeleteBuyersForm
     */
    public ViewDeleteBuyersForm() {
        initComponents();
    ...
    public ViewDeleteBuyersForm(MainMenuForm mainMenu) {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new ViewDeleteBuyersForm().setVisible(true));
    }
